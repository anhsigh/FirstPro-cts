...
import exporterV1 as exporterV1  # Import module exporter.py
...
if nut_them:
    if mo_ta:
        su_kien = {"mô tả": mo_ta, "ngày": ngay, "thời gian": thoi_gian}
...
if st.button("Lưu vào CSV"):
    thanh_cong, thong_bao = exporterV1.luu_lich_csv(
        st.session_state["lich_da_luu"]
    )
    if thanh_cong:
